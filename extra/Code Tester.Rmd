...
banking_test[] <- lapply(banking_test,as.integer)
  
cor(banking_test)

#ggpairs(banking_test, upper = list(continuous = "points"))
library(sjPlot)
#sjp.corr(factor(banking_test))
#sjt.corr(factor(banking_test))
#corrplot(banking_test)
#catcorrm <- function(vars,dat) sapply(vars, function(y) sapply(vars, function(x) assocstats(table(dat[,x], dat[,y]))$cramer))
#v<-variable.names(banking_test)
#catcorrm(v,banking_test)
```
