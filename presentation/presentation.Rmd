...
## Which variables (or combinations of these) are the most important indicators when determining whether an individual will subscribe to a term deposit? {data-background-image="img/confetti.jpg"}


# Our Methodology

We built a logistic regression model to answer this question...
