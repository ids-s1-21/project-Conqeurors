...
>>>>>>> c3c600444637b52707c53eac468929540cdb79e3
...
----
```{r visualization_job,echo = FALSE }
banking_train%>%
...
```
----
```{r visualization_housing,echo = FALSE }
banking_train%>%
...
Our initial Results were surprisingly high:
...
banking_pred %>%
  mutate(
    ...
    subscribed_pred = if_else(.pred_1>cutoff, "Client Predicted to Subscribe", "Client Predicted to Not Subscribe") )%>%
      ...
      kable(col.names = c("","Client did not Subscribe", "Client Subscribed", formtat = "html")
  )
```
# Cross Validation
