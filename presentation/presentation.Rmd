...
banking_train%>%
  ...
  labs(
    y = "Outcome",
    x = "Days",
    title = "Relationship between the number of days since a client was contacted
    and whether they subscribed"
  ) 
```
...
```{r initial result, echo = FALSE, out.width = "60%", fig.align = "center"}
include_graphics("https://c56a8771599045dc83d759202a2b79d2.app.rstudio.cloud/file_show?path=%2Fcloud%2Fproject%2FLogistic+Model%2FLogistic_Model_files%2Ffigure-gfm%2Fprediction-1.png")
```
...
```{r final result, echo = FALSE, out.width = "60%", fig.align = "center"}
include_graphics("https://c56a8771599045dc83d759202a2b79d2.app.rstudio.cloud/file_show?path=%2Fcloud%2Fproject%2FLogistic+Model%2FLogistic_Model_files%2Ffigure-gfm%2FFinal_Test-1.png")
```

```{r Final_Test, echo = FALSE}
...
At the end it is safe to say that there is no real correlation between any of the variables and their decision to subscribe or not.
